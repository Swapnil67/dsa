...
// * XOR Method [For UnSorted Array]
// * TIME COMPLEXITY O(N)
// * SPACE COMPLEXITY O(1)
int optimalA(std::vector<int> arr) {
  int xr = 0;
...
// * ------------------------- APPROACH 4: Optimal B APPROACH -------------------------`
// * Binary Search [For Sorted Array]
// * TIME COMPLEXITY O(logN)
// * SPACE COMPLEXITY O(1)
int optimalB(std::vector<int> arr) {
...
int main() {
  ...
  // int singleNumber = optimalA(arr);
  int singleNumber = optimalB(arr);
